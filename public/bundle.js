...
var deleteBooks = exports.deleteBooks = function deleteBooks(_id) {
  return {
    type: "DELETE_BOOK",
    payload: _id
  };
...
var _booksActions = __webpack_require__(209);

var _cartActions = __webpack_require__(230);
...
store.dispatch((0, _booksActions.deleteBooks)({ _id: 1 }));
...
store.dispatch((0, _cartActions.addToCart)([{ _id: 1 }]));
